...
```code
git clone https://github.com/f5minions/2026-devops-academy.git
```

2. 3.nginx-gateway-fabric/labs 경로로 이동 후 9개의 랩을 순차적으로 진행합니다.

```code
cd 3.nginx-gateway-fabric/labs
```

## 9가지 Gateway API 활용사례
...
공식 NGINX Gateway Fabric 리포지토리에서 추가적인 사례를 제공하고 있기 때문에 참조하시고 활용하세요.

공식 리포지토리의 예제:[examples](https://github.com/nginx/nginx-gateway-fabric/tree/main/examples)
