...
upstream bluebullet {
    ...
    random two least_conn;  # Only valid if using NGINX Plus
}
...
헤더를 추가하여 요청을 전송하기 위해 확장 기능을 추가합니다.

![firefox-addon](images/firefox-addon.png)

modify header value 확장 기능을 검색하고 추가합니다.

![firefox-search-addon](images/firefox-search-addon.png)

![firefox-add-modify-header-value](images/firefox-add-modify-header-value.png)
...
### 예시: 20/80 분할로 전환 (Gradual Rollout)

Blue 서버의 비중을 낮추고 Green 서버의 비중을 높여 안정성을 검증합니다.
